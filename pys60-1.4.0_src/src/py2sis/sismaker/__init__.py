...
class SISMaker(object):
    ...
    def make_sis(self, src, sisfile, uid=None, appname=None, caps=None, presdk20=False, sdk30=False, armv5=False, **kw):
        ...
        if sdk30:
            utils.make_app_sdk30(appname, uid, self.tempdir, TEMPLATE_DIR_EKA2, caps, armv5)
        else:
