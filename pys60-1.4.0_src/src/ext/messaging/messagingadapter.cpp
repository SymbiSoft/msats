...
CSmsSendHandler* CSmsSendHandler::NewL(MMsvObserver& aObserver, 
            const TDesC& aTelNum, const TDesC& aMsgBody, const TInt encoding)
{
  CSmsSendHandler* self = CSmsSendHandler::NewLC(aObserver, aTelNum, aMsgBody, encoding);
  CleanupStack::Pop();
  return self;
}
            ...
            const TDesC& aTelNum, const TDesC& aMsgBody, const TInt encoding)
{
    CSmsSendHandler* self = new (ELeave) CSmsSendHandler(
                                      aObserver, aTelNum, aMsgBody, encoding);
