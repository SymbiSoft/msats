...
{
 public:
  static CSmsSendHandler* NewL(MMsvObserver&, const TDesC&, const TDesC&, const TInt);
  static CSmsSendHandler* NewLC(MMsvObserver&, const TDesC&, const TDesC&, const TInt);
 ...
 protected:
  void RunL();
  CSmsSendHandler(MMsvObserver& aObserver, const TDesC& aTelNum, const TDesC& aMsgBody, const TInt encoding ) :
    CMsvHandler(aObserver), iPhase(EIdle), iTelNum(aTelNum), iMessageText(aMsgBody), iEncoding(encoding) {;}
