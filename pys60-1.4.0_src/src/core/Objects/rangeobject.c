...
const static PyMethodDef range_methods[] = {
...
const static PyMemberDef range_members[] = {
...
const static PyGetSetDef range_getsets[] = {
...
const static PySequenceMethods range_as_sequence = {
...
#else
const PyTypeObject c_PyRange_Type = {
