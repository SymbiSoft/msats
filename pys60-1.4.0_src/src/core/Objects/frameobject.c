...
const static PyMemberDef frame_memberlist[] = {
...
const static PyGetSetDef frame_getsetlist[] = {
...
#else
#define free_list ((PyFrameObject*)(pyglobals->FO_free_list))
#define numfree (pyglobals->numfree)
#endif
...
#else
const PyTypeObject c_PyFrame_Type = {
...
#else
	SPy_Python_globals* pyglobals = PYTHON_GLOBALS; // avoid TLS reads
#define builtin_object (pyglobals->builtin_object)
#endif
