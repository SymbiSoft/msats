...
#else
#define TestError (SPyGetGlobalString("TestError"))
#endif
...
static const PyMethodDef TestMethods[] = {
...
init_testcapi(void)
{
	PyObject *m, *d;
#ifndef SYMBIAN
	m = Py_InitModule("_testcapi", (PyMethodDef*)TestMethods);

	TestError = PyErr_NewException("_testcapi.error", NULL, NULL);
	d = PyModule_GetDict(m);
	PyDict_SetItemString(d, "error", TestError);
#else
	PyObject* TestError_ob = PyErr_NewException("_testcapi.error", NULL, NULL);
	m = Py_InitModule("_testcapi", (PyMethodDef*)TestMethods);

	SPyAddGlobalString("TestError", TestError_ob);
	d = PyModule_GetDict(m);
	PyDict_SetItemString(d, "error", TestError_ob);
#endif
}
