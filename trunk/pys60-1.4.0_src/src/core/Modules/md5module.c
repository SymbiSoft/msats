...
#else
#define MD5type ((PYTHON_GLOBALS->tobj).t_MD5)
#endif
...
#else
const static PyMethodDef md5_methods[] = {
	{"update",    (PyCFunction)md5_update,    METH_OLDARGS, NULL},
	{"digest",    (PyCFunction)md5_digest,    METH_OLDARGS, NULL},
	{"hexdigest", (PyCFunction)md5_hexdigest, METH_OLDARGS, NULL},
	{"copy",      (PyCFunction)md5_copy,      METH_OLDARGS, NULL},
	{NULL, NULL}			     /* sentinel */
};
#endif
...
#else
const static PyTypeObject c_MD5type = {
#endif
...
#ifndef SYMBIAN
const static PyMethodDef md5_functions[] = {
...
#else
const static PyMethodDef md5_functions[] = {
	{"new",		(PyCFunction)MD5_new, METH_VARARGS, NULL},
	{"md5",		(PyCFunction)MD5_new, METH_VARARGS, NULL}, /* Backward compatibility */
	{NULL,		NULL}	/* Sentinel */
};
#endif
