...
pattern_sub(PatternObject* self, PyObject* args, PyObject* kw)
{
    ...
    PyObject* string;
    int count = 0;
    static const char *const kwlist[] = { "repl", "string", "count", NULL };
...
const static PyMethodDef pattern_methods[] = {
...
#else
const static PyTypeObject c_Pattern_Type = {
#endif
...
match_groups(MatchObject* self, PyObject* args, PyObject* kw)
{
    ...
    static const char *const kwlist[] = { "default", NULL };
...
const static PyMethodDef match_methods[] = {
...
#else
const static PyTypeObject c_Match_Type = {
#endif
    PyObject_HEAD_INIT(NULL)
...
const static PyMethodDef scanner_methods[] = {
...
#else
const static PyTypeObject c_Scanner_Type = {
#endif
    PyObject_HEAD_INIT(NULL)
...
const static PyMethodDef _functions[] = {
    {"compile", _compile, 1},
...
init_sre(void)
{
    ...
    /* Patch object types */
#ifdef SYMBIAN
    Pattern_Type = c_Pattern_Type;
    Match_Type = c_Match_Type;
    Scanner_Type = c_Scanner_Type;
#endif
