...
DL_EXPORT(int)
_PyUnicode_IsLinebreak(Py_UNICODE ch)
{
...
DL_EXPORT(int)
_PyUnicode_IsTitlecase(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
DL_EXPORT(int)
_PyUnicode_ToDecimalDigit(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
DL_EXPORT(int)
_PyUnicode_IsDecimalDigit(Py_UNICODE ch)
{
...
DL_EXPORT(int)
_PyUnicode_ToDigit(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
DL_EXPORT(int)
_PyUnicode_IsDigit(Py_UNICODE ch)
{
...
DL_EXPORT(double)
_PyUnicode_ToNumeric(Py_UNICODE ch)
{
    switch (ch) {
    case 0x3007:
	return (double) 0;
...
DL_EXPORT(int)
_PyUnicode_IsWhitespace(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
DL_EXPORT(int)
_PyUnicode_IsLowercase(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
DL_EXPORT(int)
_PyUnicode_IsUppercase(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
DL_EXPORT(int)
_PyUnicode_IsAlpha(Py_UNICODE ch)
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
