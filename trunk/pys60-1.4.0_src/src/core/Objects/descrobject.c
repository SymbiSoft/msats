...
const static PyMemberDef descr_members[] = {
	{"__objclass__", T_OBJECT, offsetof(PyDescrObject, d_type), READONLY},
	{"__name__", T_OBJECT, offsetof(PyDescrObject, d_name), READONLY},
	{0}
};

const static PyGetSetDef method_getset[] = {
...
const static PyGetSetDef member_getset[] = {
...
const static PyGetSetDef getset_getset[] = {
...
const static PyGetSetDef wrapper_getset[] = {
...
#else
const PyTypeObject c_PyMethodDescr_Type = {
...
PyTypeObject PyMemberDescr_Type = {
	PyObject_HEAD_INIT(&PyType_Type)
#else
const PyTypeObject c_PyMemberDescr_Type = {
	PyObject_HEAD_INIT(NULL)
#endif
	0,
	"member_descriptor",
...
PyTypeObject PyGetSetDescr_Type = {
	PyObject_HEAD_INIT(&PyType_Type)
#else
const PyTypeObject c_PyGetSetDescr_Type = {
	PyObject_HEAD_INIT(NULL)
#endif
	0,
	"getset_descriptor",
...
PyTypeObject PyWrapperDescr_Type = {
	PyObject_HEAD_INIT(&PyType_Type)
#else
const PyTypeObject c_PyWrapperDescr_Type = {
	PyObject_HEAD_INIT(NULL)
#endif
	0,
	"wrapper_descriptor",
