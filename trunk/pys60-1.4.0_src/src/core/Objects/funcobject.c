...
const static PyMemberDef func_memberlist[] = {
...
const static PyGetSetDef func_getsetlist[] = {
...
#else
const PyTypeObject c_PyFunction_Type = {
...
const static char classmethod_doc[] =
#ifdef SYMBIAN
"";
#else
...
PyTypeObject PyClassMethod_Type = {
	PyObject_HEAD_INIT(&PyType_Type)
#else
const PyTypeObject c_PyClassMethod_Type = {
	PyObject_HEAD_INIT(NULL)
#endif
	0,
	"classmethod",
...
const static char staticmethod_doc[] =
#ifdef SYMBIAN
"";
#else
...
PyTypeObject PyStaticMethod_Type = {
	PyObject_HEAD_INIT(&PyType_Type)
#else
const PyTypeObject c_PyStaticMethod_Type = {
	PyObject_HEAD_INIT(NULL)
#endif
	0,
	"staticmethod",
