...
#else
#define PyOS_InputHook (PYTHON_GLOBALS->PyOS_InputHook)
#endif
...
#else
#define PyOS_ReadlineFunctionPointer (PYTHON_GLOBALS->PyOS_ReadlineFunctionPointer)
#endif
...
{
	char *rv;
	char *(*fp_readln)(char*) = PyOS_ReadlineFunctionPointer;

	if (fp_readln == NULL) {
			PyOS_ReadlineFunctionPointer = PyOS_StdioReadline;
			fp_readln = PyOS_ReadlineFunctionPointer;
	}
