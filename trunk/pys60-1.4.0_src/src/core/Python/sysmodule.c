...
const static char displayhook_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static char excepthook_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static char exc_info_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static char getdefaultencoding_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static char setdefaultencoding_doc[] =
#ifdef SYMBIAN
"";
#else
...
#else
#define whatstrings (PYTHON_GLOBALS->whatstrings)
#endif
...
trace_init(void)
{
	...
	static const char *const whatnames[4] = {"call", "exception", "line", "return"};
...
const static char settrace_doc[] =
#ifdef SYMBIAN
"";
#else
"settrace(function)\n\
...
const static char setprofile_doc[] =
#ifdef SYMBIAN
"";
#else
"setprofile(function)\n\
...
const static char setcheckinterval_doc[] =
#ifdef SYMBIAN
"";
#else
"setcheckinterval(n)\n\
...
const static char setrecursionlimit_doc[] =
#ifdef SYMBIAN
"";
#else
"setrecursionlimit(n)\n\
...
const static char getrecursionlimit_doc[] =
#ifdef SYMBIAN
"";
#else
"getrecursionlimit()\n\
...
const static char setdlopenflags_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static char getdlopenflags_doc[] =
#ifdef SYMBIAN
"";
#else
"getdlopenflags() -> int\n\
...
const static char getrefcount_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static char getframe_doc[] =
#ifdef SYMBIAN
"";
#else
...
const static PyMethodDef sys_methods[] = {
...
#else
#define warnoptions (PYTHON_GLOBALS->warnoptions)
#endif
