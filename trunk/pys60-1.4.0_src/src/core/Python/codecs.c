...
#else
#define _PyCodec_SearchPath (PYTHON_GLOBALS->_PyCodec_SearchPath)
#define _PyCodec_SearchCache (PYTHON_GLOBALS->_PyCodec_SearchCache)
#endif
...
#else
#define import_encodings_called (PYTHON_GLOBALS->import_encodings_called)
#endif
